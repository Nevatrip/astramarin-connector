...
const api = rest.wrap(basicAuth).wrap(mime)
...
class astraMarin {
  ...
  set serviceGroupID (serviceGroupID) {
    this.trip.serviceGroupID = serviceGroupID
  }
  get serviceGroupID () {
    return this.trip.serviceGroupID
  }

  set serviceID (serviceID) {
    this.trip.serviceID = serviceID
  }
  get serviceID () {
    return this.trip.serviceID
  }

  set eventID (eventID) {
    this.trip.eventID = eventID
  }
  get eventID () {
    return this.trip.eventID
  }

  set venueID (venueID) {
    this.trip.venueID = venueID
  }
  get venueID () {
    return this.trip.venueID
  }

  set categoryID (categoryID) {
    this.trip.categoryID = categoryID
  }
  get categoryID () {
    return this.trip.categoryID
  }

  set categorySeatID (categorySeatID) {
    this.trip.categorySeatID = categorySeatID
  }
  get categorySeatID () {
    return this.trip.categorySeatID
  }

  set seatID (seatID) {
    this.trip.seatID = seatID
  }
  get seatID () {
    return this.trip.seatID
  }

  set sessionID (sessionID) {
    this.trip.sessionID = sessionID
  }
  get sessionID () {
    return this.trip.sessionID
  }

  set ticketTypeID (ticketTypeID) {
    this.trip.ticketTypeID = ticketTypeID
  }
  get ticketTypeID () {
    return this.trip.ticketTypeID
  }

  set paymentTypeID (paymentTypeID) {
    this.trip.paymentTypeID = paymentTypeID
  }
  get paymentTypeID () {
    return this.trip.paymentTypeID
  }

  set resident (resident) {
    this.trip.resident = resident
  }
  get resident () {
    return this.trip.resident
  }

  set typePriceID (typePriceID) {
    this.trip.typePriceID = typePriceID
  }
  get typePriceID () {
    return this.trip.typePriceID
  }

  set orderID (orderID) {
    this.trip.orderID = orderID
  }
  get orderID () {
  ...
  async _checkConnection () {
    const body = await api({
      ...
      return fastXmlParser.parse(response.entity)
    })
  ...
  async _getServiceGroup () {
    await api({
      ...
      this._getServiceGroup = JSON.parse(
        body['m:GetServiceGroupResponse']['m:return']['d4p1:ServiceType']['d4p1:StringJSON']
      )
    })
  ...
  async _servicesOnDate (dateFrom = isRequired('dateFrom'), dateTo = '', serviceGroupID = '') {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._servicesOnDate = JSON.parse(
        body['m:ServicesOnDateResponse']['m:return']['d4p1:Services']['d4p1:StringJSON']
      )
    })
  ...
  async _EventsOnDate (date = isRequired('date'), serviceID, serviceGroupID = '', eventID = '') {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._EventsOnDate = JSON.parse(
        body['m:EventsOnDateResponse']['m:return']['d4p1:Event']['d4p1:StringJSON']
      )
    })
  ...
  async _SeatСategory (venueID, eventID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._SeatСategory = JSON.parse(body['m:Seat']['m:return']['d4p1:Seats']['d4p1:StringJSON'])
    })
  ...
  async _SeatsOnEvent (eventID, categorySeatID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._SeatsOnEvent = JSON.parse(
        body['m:SeatsOnEventResponse']['m:return']['d4p1:Seats']['d4p1:StringJSON']
      )
    })
  ...
  async _BookingSeat (sessionID, eventID, seatID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._BookingSeat = JSON.parse(
        body['m:BookingSeatResponse']['m:return']['d4p1:Book']['d4p1:StringJSON']
      )
    })
  ...
  async _CancelBookingSeat (sessionID, eventID, seatID = '') {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._CancelBookingSeat = JSON.parse(
        body['m:CancelBookingSeatResponse']['m:return']['d4p1:CancelBook']['d4p1:StringJSON']
      )
    })
  ...
  async _GetTicketType (serviceID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._GetTicketType = JSON.parse(
        body['m:GetTicketTypeResponse']['m:return']['d4p1:TicketType']['d4p1:StringJSON']
      )
    })
  ...
  async _GetPaymentType () {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._GetPaymentType = JSON.parse(
        body['m:GetPaymentTypeResponse']['m:return']['d4p1:PaymentType']['d4p1:StringJSON']
      )
    })
  ...
  async _GetSeatPrice (
    ...
    if (!this.trip.ticketTypeID) {
      throw new Error('ticketTypeID is not defined')
    }
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._GetSeatPrice = JSON.parse(
        body['m:GetSeatPriceResponse']['m:return']['d4p1:Price']['d4p1:StringJSON']
      )
    })
  ...
  async _MenuOnTypePrice (typePriceID) {
    ...
    if (!this.trip.typePriceID) {
      throw new Error('typePriceID is not defined')
    }
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._MenuOnTypePrice = JSON.parse(
        body['m:MenuOnTypePriceResponse']['m:return']['d4p1:Menu']['d4p1:StringJSON']
      )
    })
  ...
  async _SaleSeat (order = [], orderID, sessionID, paymentTypeID, eventID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._SaleSeat = JSON.parse(
        body['m:SaleSeatResponse']['m:return']['d4p1:Sale']['d4p1:StringJSON']
      )
    })
  ...
  async _PaymentConfirmation (orderID) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._PaymentConfirmation = JSON.parse(
        body['m:PaymentConfirmationResponse']['m:return']['d4p1:PaymentConfirm']['d4p1:StringJSON']
      )
    })
  ...
  async _ChekDeposit (amount = 0) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._ChekDeposit = JSON.parse(
        body['m:ChekDepositResponse']['m:return']['d4p1:ChekDeposit']['d4p1:StringJSON']
      )
    })
  ...
  async _GetDeposit (date) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._GetDeposit = JSON.parse(
        body['m:GetDepositResponse']['m:return']['d4p1:GetDeposit']['d4p1:StringJSON']
      )
    })
  ...
  async _ReturnOrder (orderID, order = []) {
    ...
    await api({
      ...
      const jsonObj = fastXmlParser.parse(response.entity)
      const body = jsonObj['soap:Envelope']['soap:Body']
      this._ReturnOrder = JSON.parse(
        body['m:ReturnOrderResponse']['m:return']['d4p1:ReturnOrder']['d4p1:StringJSON']
      )
    })
  ...
  // 18
  async _GetDiscountCard () {
    return this
  }

  // 19
  async _GetInformationSource () {
    return this
  }

  // 20
  async _RegisterDiscountCard () {
    return this
  }

  // 21
  async _GetAmountCertificate () {
    return this
  }
}
